...
import gov.nih.nci.coppa.services.outcomes.business.common.BusinessConstants;
import gov.nih.nci.coppa.services.outcomes.business.stubs.BusinessResourceProperties;
 ...
 * 
 */
public class BusinessResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(BusinessResourceHome.class);
			...
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, BusinessConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, BusinessConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		BusinessResource resource = (BusinessResource) super.find(key);
		return resource;
	}
