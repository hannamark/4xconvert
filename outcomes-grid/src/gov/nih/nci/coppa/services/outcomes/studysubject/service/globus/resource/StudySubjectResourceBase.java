 ...
 * 
 */
public abstract class StudySubjectResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudySubjectResourceBase.class);

	private StudySubjectResourceConfiguration configuration;
    ...
    public StudySubjectResourceBase() {
    }
	...
	public StudySubjectResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (StudySubjectResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
