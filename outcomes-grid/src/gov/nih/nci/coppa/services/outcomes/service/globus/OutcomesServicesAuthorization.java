 ...
 * 
 */
public class OutcomesServicesAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices";
	
	Map authorizationClassMap = new HashMap();
	
	
	public OutcomesServicesAuthorization() {
	}
