 ...
 */
public abstract class UserClientBase extends ServiceSecurityClient {	
	protected UserPortType portType;
	...
	public UserClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public UserClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected UserPortType createPortType() throws RemoteException {

		UserServiceAddressingLocator locator = new UserServiceAddressingLocator();
		...
		UserPortType port = null;
		try {
			port = locator.getUserPortTypePort(getEndpointReference());
		} catch (Exception e) {
