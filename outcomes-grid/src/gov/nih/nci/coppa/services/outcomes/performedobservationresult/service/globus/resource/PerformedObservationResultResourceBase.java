 ...
 * 
 */
public abstract class PerformedObservationResultResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(PerformedObservationResultResourceBase.class);

	private PerformedObservationResultResourceConfiguration configuration;
    ...
    public PerformedObservationResultResourceBase() {
    }
	...
	public PerformedObservationResultResourceConfiguration getConfiguration() {
		...
		servicePath+="/PerformedObservationResult";
		...
		try {
			...
			this.configuration = (PerformedObservationResultResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
