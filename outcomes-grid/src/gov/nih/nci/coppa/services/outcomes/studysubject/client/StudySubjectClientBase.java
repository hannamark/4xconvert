 ...
 */
public abstract class StudySubjectClientBase extends ServiceSecurityClient {	
	protected StudySubjectPortType portType;
	...
	public StudySubjectClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public StudySubjectClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected StudySubjectPortType createPortType() throws RemoteException {

		StudySubjectServiceAddressingLocator locator = new StudySubjectServiceAddressingLocator();
		...
		StudySubjectPortType port = null;
		try {
			port = locator.getStudySubjectPortTypePort(getEndpointReference());
		} catch (Exception e) {
