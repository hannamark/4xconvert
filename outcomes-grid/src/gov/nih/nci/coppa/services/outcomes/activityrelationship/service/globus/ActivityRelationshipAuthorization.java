 ...
 * 
 */
public class ActivityRelationshipAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices/ActivityRelationship";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ActivityRelationshipAuthorization() {
	}
	...
	public void authorizeGetByTargetPerformedActivity(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeGetBySourcePerformedActivity(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getByTargetPerformedActivity")){
			authorizeGetByTargetPerformedActivity(peerSubject, context, operation);
			return true;
