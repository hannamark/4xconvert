 ...
 * 
 */
public abstract class ActivityRelationshipResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(ActivityRelationshipResourceBase.class);

	private ActivityRelationshipResourceConfiguration configuration;
    ...
    public ActivityRelationshipResourceBase() {
    }
	...
	public ActivityRelationshipResourceConfiguration getConfiguration() {
		...
		servicePath+="/ActivityRelationship";
		...
		try {
			...
			this.configuration = (ActivityRelationshipResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
