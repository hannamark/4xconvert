 ...
 * 
 */
public class UserAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices/User";
	...
	public void authorizeGetUser(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeCreateUser(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeUpdateUser(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getUser")){
			authorizeGetUser(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("createUser")){
			authorizeCreateUser(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("updateUser")){
			authorizeUpdateUser(peerSubject, context, operation);
			return true;
