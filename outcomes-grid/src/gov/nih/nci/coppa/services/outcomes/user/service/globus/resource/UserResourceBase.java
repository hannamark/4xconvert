 ...
 * 
 */
public abstract class UserResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(UserResourceBase.class);

	private UserResourceConfiguration configuration;
	...
	public UserResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (UserResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
