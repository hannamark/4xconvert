 ...
 * 
 */
public class StudySubjectAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices/StudySubject";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudySubjectAuthorization() {
	}
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getByStudySite")){
			authorizeGetByStudySite(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getOutcomes")){
			authorizeGetOutcomes(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("createOutcomes")){
			authorizeCreateOutcomes(peerSubject, context, operation);
			return true;
