 ...
 * 
 */
public abstract class SubmissionResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(SubmissionResourceBase.class);

	private SubmissionResourceConfiguration configuration;
	...
	public SubmissionResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (SubmissionResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
