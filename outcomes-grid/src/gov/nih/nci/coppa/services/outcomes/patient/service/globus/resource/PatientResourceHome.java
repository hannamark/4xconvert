...
import gov.nih.nci.coppa.services.outcomes.patient.common.PatientConstants;
import gov.nih.nci.coppa.services.outcomes.patient.stubs.PatientResourceProperties;
 ...
 * 
 */
public class PatientResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(PatientResourceHome.class);
			...
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, PatientConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, PatientConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		PatientResource resource = (PatientResource) super.find(key);
		return resource;
	}
