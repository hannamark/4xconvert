...
public class SubmissionClient extends SubmissionClientBase implements SubmissionI {
    ...
    throws RemoteException {
        ...
        ST desc_st = new ST();
        desc_st.setValue("submission description");
        submission.setDescription(desc_st);

        ST createUser_st = new ST();
        createUser_st.setValue("createUser");
        submission.setCreateUser(createUser_st);
