 ...
 * 
 */
public abstract class OutcomesServicesResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(OutcomesServicesResourceBase.class);

	private OutcomesServicesResourceConfiguration configuration;
    ...
    public OutcomesServicesResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((OutcomesServicesResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(OutcomesServicesConstants.SERVICEMETADATA);
	...
	public OutcomesServicesResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (OutcomesServicesResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((OutcomesServicesResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
