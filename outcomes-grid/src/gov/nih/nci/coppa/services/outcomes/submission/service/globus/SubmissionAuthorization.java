 ...
 * 
 */
public class SubmissionAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices/Submission";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SubmissionAuthorization() {
	}
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getByStudyProtocol")){
