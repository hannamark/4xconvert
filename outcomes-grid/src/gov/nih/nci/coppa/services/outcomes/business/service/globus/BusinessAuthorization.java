...
public class BusinessAuthorization implements PDP {
	...
	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/OutcomesServices/Business";
	...
	public void authorizeWrite(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("write")){
			authorizeWrite(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
