 ...
 * 
 */
public class StudyOverallStatusServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyOverallStatusService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyOverallStatusServiceAuthorization() {
	}
