 ...
 * 
 */
public abstract class ArmServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(ArmServiceResourceBase.class);

	private ArmServiceResourceConfiguration configuration;
	...
	public ArmServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (ArmServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
