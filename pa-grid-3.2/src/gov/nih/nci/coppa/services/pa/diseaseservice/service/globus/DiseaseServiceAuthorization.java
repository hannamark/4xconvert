 ...
 * 
 */
public class DiseaseServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/DiseaseService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public DiseaseServiceAuthorization() {
	}
