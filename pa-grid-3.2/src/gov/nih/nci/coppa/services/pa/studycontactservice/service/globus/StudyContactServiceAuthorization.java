 ...
 * 
 */
public class StudyContactServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyContactService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyContactServiceAuthorization() {
	}
