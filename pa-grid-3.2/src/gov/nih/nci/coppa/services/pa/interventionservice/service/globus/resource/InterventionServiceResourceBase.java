 ...
 * 
 */
public abstract class InterventionServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(InterventionServiceResourceBase.class);

	private InterventionServiceResourceConfiguration configuration;
    ...
    public InterventionServiceResourceBase() {
    }
	...
	public InterventionServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/InterventionService";
		...
		try {
			...
			this.configuration = (InterventionServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
