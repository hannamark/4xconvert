...
public class PrincipalInvestigatorsTest {

	public PrincipalInvestigatorsTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage
	...
	@Test
	public void runReportUsingPrincipalInvestigators() {
		...
		builder.setPrincipalInvestigator(currentOption);
