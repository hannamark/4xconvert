...
public class SearchByTrialCategoriesTest {

	public SearchByTrialCategoriesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getTrialCategories();
	...
	@Test
	public void runReportUsingTrialCategories() {
		...
		builder.setSearchByTrialCategory(currentOption);
