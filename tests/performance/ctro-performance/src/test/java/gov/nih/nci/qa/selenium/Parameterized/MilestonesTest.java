...
public class MilestonesTest {
	...
	public MilestonesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getMilestones();
	...
	@Test
	public void runReportUsingMilestones() {
		...
		builder.setMilestone(currentOption);
