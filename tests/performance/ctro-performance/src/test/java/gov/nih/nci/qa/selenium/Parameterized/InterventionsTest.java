...
public class InterventionsTest {

	public InterventionsTest(String currentOption) {
	...
	@Test
	public void runReportUsingInterventions() {
		// The @Before method navigates us to the page.
		adHocReportPage.setInterventions(currentOption);
