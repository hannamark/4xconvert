...
public class SearchBySubmissionTypesTest {

	public SearchBySubmissionTypesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getSubmissionTypes();
	...
	@Test
	public void runReportUsingSubmissionTypes() {
		...
		builder.setSearchBySubmissionType(currentOption);
