...
public class LeadOrganizationsTest {

	public LeadOrganizationsTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getLeadOrganizations();
	...
	@Test
	public void runReportUsingLeadOrganizations() {
		...
		builder.setLeadOrganizationDropDown(currentOption);
