...
public class PrimaryPurposesTest {

	public PrimaryPurposesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getPrimaryPurposes();
	...
	@Test
	public void runReportUsingPrimaryPurposes() {
		...
		builder.setPrimaryPurpose(currentOption);
