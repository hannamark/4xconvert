...
public class TrialPhasesTest {

	public TrialPhasesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getTrialPhases();
	...
	@Test
	public void runReportUsingTrialPhases() {
		...
		builder.setTrialPhase(currentOption);
