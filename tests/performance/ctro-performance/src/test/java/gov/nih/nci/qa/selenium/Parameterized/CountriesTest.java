...
public class CountriesTest {
	...
	public CountriesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> countries = adHocReportPage.getCountries();

		// Turn the options we collected into test parameters.
		List<String[]> options = new LinkedList<String[]>();
		for (String country : countries) {
			options.add(new String[] { country });
		}
	...
	@Test
	public void runReportUsingCountries() {
		// The @Before method navigates us to the page.
		adHocReportPage.setTrialGeographicArea(currentOption,
