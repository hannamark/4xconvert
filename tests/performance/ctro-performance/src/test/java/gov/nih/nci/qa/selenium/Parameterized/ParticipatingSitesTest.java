...
public class ParticipatingSitesTest {

	public ParticipatingSitesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> sites = adHocReportPage.getParticipatingSites();

		// Turn the options we collected into test parameters.
		List<String[]> options = new LinkedList<String[]>();
		for (String site : sites) {
			options.add(new String[] { site });
		}
	...
	@Test
	public void runReportUsingParticipatingSites() {
		// The @Before method navigates us to the page.
		adHocReportPage.setParticipatingSites(currentOption);
