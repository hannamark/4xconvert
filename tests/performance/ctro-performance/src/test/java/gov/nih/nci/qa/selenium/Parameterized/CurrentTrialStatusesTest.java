...
public class CurrentTrialStatusesTest {

	public CurrentTrialStatusesTest(String currentOption) {
	...
	public static Collection<String[]> getOptions() {
		...
		List<String> primaryPurposes = adHocReportPage.getCurrentTrialStatues();
	...
	@Test
	public void runReportUsingCurrentTrialStatues() {
		...
		builder.setCurrentTrialStatus(currentOption);
