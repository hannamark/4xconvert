...
public class AdHocPageDiseaseLookUp extends LoadableComponent<AdHocPageDiseaseLookUp>{
	...
	DiseaseLocatorResultsTable diseaseLocatorResultsTable;
	...
	public void setIncludeSynonym(Boolean includeSynonym) {
		if (includeSynonym) {
			includeSynonymCheckbox.click();
		} else {
			if (includeSynonymCheckbox.isSelected()) {
				includeSynonymCheckbox.click();
			}
		}
	}
	...
	public void setExactMatch(Boolean exactMatchOnly) {
		if (exactMatchOnly) {
			exactMatchOnlyCheckbox.click();
		} else {
			if (exactMatchOnlyCheckbox.isSelected()) {
				exactMatchOnlyCheckbox.click();
			}
		}
	}
	...
	protected void isLoaded() throws Error {
		...
		if (!"Disease".equals(popUp.getText())){
			throw new IllegalStateException("This is not the Search Diseases Popup!");
		}
