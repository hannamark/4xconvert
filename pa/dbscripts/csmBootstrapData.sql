...
INSERT INTO CSM_APPLICATION(APPLICATION_NAME, APPLICATION_DESCRIPTION) VALUES ('pa', 'pa');

INSERT INTO CSM_PROTECTION_ELEMENT(PROTECTION_ELEMENT_NAME, PROTECTION_ELEMENT_DESCRIPTION, OBJECT_ID, APPLICATION_ID)
    VALUES ('pa', 'PA Admin Application Protection Element', 'pa', 1);
...
INSERT INTO CSM_GROUP (GROUP_NAME, GROUP_DESC, APPLICATION_ID) VALUES ('Curator', 'Curator group - security role', (select application_id from csm_application where application_name = 'pa'));
...
INSERT INTO CSM_USER_PE(PROTECTION_ELEMENT_ID, USER_ID) VALUES ((select protection_element_id from csm_protection_element where protection_element_name = 'pa'), (select user_id from csm_user where login_name = 'subscriber'));

INSERT INTO CSM_GROUP (GROUP_NAME, GROUP_DESC, APPLICATION_ID) VALUES ('Subscriber', 'Topic Subscriber group - security role', (select application_id from csm_application where application_name = 'pa'));
...
INSERT INTO CSM_USER_PE(PROTECTION_ELEMENT_ID, USER_ID) VALUES ((select protection_element_id from csm_protection_element where protection_element_name = 'pa'), (select user_id from csm_user where login_name = 'publisher'));

INSERT INTO CSM_GROUP (GROUP_NAME, GROUP_DESC, APPLICATION_ID) VALUES ('Publisher', 'Topic Publisher group - security role', (select application_id from csm_application where application_name = 'pa'));
...
INSERT INTO CSM_USER_PE(PROTECTION_ELEMENT_ID, USER_ID) VALUES ((select protection_element_id from csm_protection_element where protection_element_name = 'pa'), (select user_id from csm_user where login_name = 'ejbclient'));

INSERT INTO CSM_GROUP (GROUP_NAME, GROUP_DESC, APPLICATION_ID) VALUES ('client', 'remote client group - security role', (select application_id from csm_application where application_name = 'pa'));
...
INSERT INTO CSM_USER_PE(PROTECTION_ELEMENT_ID, USER_ID) VALUES ((select protection_element_id from csm_protection_element where protection_element_name = 'pa'), (select user_id from csm_user where login_name = 'firebird-nci'));
