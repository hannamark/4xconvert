...
DROP TABLE IF EXISTS INTERVENTION_OTHER;
...
CREATE TABLE INTERVENTION_OTHER (
    ID SERIAL NOT NULL,
    NAME VARCHAR(200),
    INTERVENTION_ID BIGINT NOT NULL,
    STATUS_CODE VARCHAR(200),
...
ALTER TABLE INTERVENTION_OTHER ADD CONSTRAINT FK_INTERVENTION_OTHER_INTERVENTION
FOREIGN KEY (INTERVENTION_ID) REFERENCES INTERVENTION (ID)
ON DELETE CASCADE;
