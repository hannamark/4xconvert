...
CREATE TABLE TEMP_STUDY_INDIDE (
    ...
    CONSTRAINT STAGE_STUDY_IND_IDE_PKEY PRIMARY KEY (identifier),
    CONSTRAINT FK_STAGE_STUDY_FUNDING_STAGE_STUDY_PROTOCOL FOREIGN KEY (TEMP_STUDY_PROTOCOL_IDENTIFIER)
