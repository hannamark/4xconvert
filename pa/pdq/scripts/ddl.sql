...
ALTER TABLE pdq_disease ALTER COLUMN disease_code SET NOT NULL;
ALTER TABLE pdq_disease ADD CONSTRAINT disease_unique UNIQUE (disease_code);
...
ALTER TABLE study_disease ADD CONSTRAINT fk_study_disease_disease FOREIGN KEY (disease_identifier)
      REFERENCES pdq_disease (identifier) MATCH SIMPLE
