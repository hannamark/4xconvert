...
Sql getPoSourceConnection() {
    ...
    def poSourceConnection = Sql.newInstance(props['po.jdbc.url'], props['datawarehouse.po.db.username'],
         props['datawarehouse.po.db.password'], props['datawarehouse.po.jdbc.driver'])
}
