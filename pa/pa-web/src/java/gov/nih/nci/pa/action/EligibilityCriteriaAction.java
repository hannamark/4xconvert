...
public class EligibilityCriteriaAction extends ActionSupport  {
    ...
    private ISDesignDetailsWebDTO setEligibilityDetailsDTO(
        ...
        if (dto != null) {
            ...
            if (dto.getDescriptionText() != null) {
                webdto.setDescriptionText(dto.getDescriptionText().getValue());
            }
            if (dto.getAgeValue().getValue() != null) {
                webdto.setAgeValue(dto.getAgeValue().getValue().toString());
            }
            if (dto.getUnit() != null) {
                webdto.setUnit(dto.getUnit().getCode());
            }
