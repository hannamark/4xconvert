...
<head>
	<title><fmt:message key="trial.login.title"/></title>
	<s:head />
</head>

<body onload="setFocusToFirstControl();">
<div id="contentwide">
 <h1><fmt:message key="trial.login.title" /></h1>
...
<s:form action="authenticate">
  <span class="formErrorMsg"> <s:actionerror /> </span>
     <table cellspacing="2" >  
            <tr>
                <td align=right>
                     <label for="userName"> <fmt:message key="trial.login.username"/></label>
                </td>
                <td align=left>
			...
			<tr>
                <td align=right>
                     <label for="Password"> <fmt:message key="trial.login.password"/></label>
                </td>
                <td align=left>
