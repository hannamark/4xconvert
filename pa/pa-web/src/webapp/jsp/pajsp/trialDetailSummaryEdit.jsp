...
<% StudyProtocolQueryDTO  studyProtocolDTO = (StudyProtocolQueryDTO) session.getAttribute("trialSummary");%>
<tr>
...
<td class="value">
     <s:textfield name="nciAccessionNumber" maxlength="200" size="35" value="<%=studyProtocolDTO.getNciIdentifier() %>" cssStyle="width:200px"/>
</td>
</tr>
<tr>
<td scope="row" class="label">
...
<td class="value">
<s:textfield name="nct" maxlength="200" size="35" value="" cssStyle="width:200px"/>
</td>
</tr>
<tr>
<td scope="row" class="label">
...
<td class="value">
    ...
    <s:textfield name="localProtocolIdentifer" maxlength="200" size="35" value="" cssStyle="width:200px"/>
</td>
</tr>       
<tr>
<tr>
	...
	<td class="value"><s:textfield name="sectrialid" maxlength="200" size="35" value="" cssStyle="width:200px"/></td>
</tr>
<tr>
<td scope="row" class="label">
    <label for="leadOrg"> 
...
<td class="value">
    <!--  <c:out value="${sessionScope.trialSummary.leadOrganizationName }"/> -->
    <s:textfield name="leadOrganizationName" maxlength="200" size="35" value="<%=studyProtocolDTO.getLeadOrganizationName() %>" cssStyle="width:200px"/>
</td>
</tr>      
<td scope="row" class="label">
...
<td class="value">
    ...
    <s:textfield name="officialTitle" maxlength="200" size="35" value="<%=studyProtocolDTO.getOfficialTitle() %>" cssStyle="width:200px"/>
</td>
</tr>       
 <tr>
	<td scope="row" class="label"><label for="acronym"><dfn title="Context sensitive help text or tooltip here.">Acronym:</dfn></label></td>
	<td class="value"><s:textfield name="acronym" maxlength="200" size="35" value="" cssStyle="width:200px"/></td>
</tr>
<!--<tr>
    <td scope="row" class="label">
