   ...
   <pa:failureMessage/>
    ...
    <table class="form">                
                <tr>
    				...
    				<td class="value">    					
                    		<s:textfield name="subGroupsWebDTO.groupNumberText" maxlength="200"  cssStyle="width:206px"/>                    
                ...
                <tr>
                    ...
                    <td class="value">
                        <s:textfield name="subGroupsWebDTO.description" maxlength="200"  cssStyle="width:206px"/>
                        <span class="formErrorMsg"> 
                                <s:fielderror>
