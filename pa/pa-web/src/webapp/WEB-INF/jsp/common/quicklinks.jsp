<li class="stdnav"><div>QUICK LINKS</div>
	<ul class="quicklinks">
        ...
        <li><a href="http://projectreporter.nih.gov/" class="external" target="new4">NIH Grants - RePORT</a></li>
        <li><a href="https://wiki.nci.nih.gov/x/7ZF4B" class="external" target="new5">User's Guide</a></li>
	</ul>
</li>