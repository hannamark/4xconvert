...
public class RegulatoryInformationDAO {
     ...
     * 
     * @param informationDTO for regulatory information
     * @throws PAException on error
    ...
    public boolean saveRegulatoryInformation(RegulatoryInformationDTO informationDTO) throws PAException {      
         ...
         try {                  
                         ...
                         results = session.createQuery(
                                     "select sp from StudyProtocol as sp where sp.id =" 
                         ...
                         studyProtocol.setFdaRegulatedIndicator(
                                 informationDTO.isFdaRegulatedInterventionIndicatorP());                  
    ...
    public List<RegulatoryAuthOrgDTO> getRegulatoryAuthorityNameId(Long regAuthID) throws PAException {          
        ...
        try {           
          ...
          List results = session.createQuery(
                  "select id, authorityName from RegulatoryAuthority as ra where ra.country.id=" + regAuthID).list();
          for (int i = 0; i < results.size(); i++) { 
    ...
    public RegulatoryInformationDTO getProtocolForEdit(long protocolId) throws PAException {
        ...
        Session session = HibernateUtil.getCurrentSession();            
                ...
                try {                                            
                        ...
                        results = session.createQuery(
                                "select ra from RegulatoryAuthority as ra where ra.id=" 
     ...
     * 
     * @param protocolId of a protocol
        ...
        Session session = HibernateUtil.getCurrentSession();            
                ...
                try {
                        ...
                        //get the reg authority
                         List resultsList = getRegulatoryAuthorityName(
                                 studyRegulatoryAuthority.getRegulatoryAuthorityID());
