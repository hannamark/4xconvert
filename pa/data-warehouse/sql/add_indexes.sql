...
CREATE INDEX DW_STUDY_OVERALL_STATUS_ADDL_CMNTS_IDX on DW_STUDY_OVERALL_STATUS(addl_comments);
...
CREATE INDEX DW_STUDY_PARTICIPATING_SITE_ACCRUAL_STATUS_COMMENTS on DW_STUDY_PARTICIPATING_SITE_ACCRUAL_STATUS(comments);
