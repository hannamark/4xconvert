 ...
 */
public abstract class HealthCareFacilityClientBase extends ServiceSecurityClient {	
	protected HealthCareFacilityPortType portType;
	...
	public HealthCareFacilityClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public HealthCareFacilityClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected HealthCareFacilityPortType createPortType() throws RemoteException {

		HealthCareFacilityServiceAddressingLocator locator = new HealthCareFacilityServiceAddressingLocator();
		...
		HealthCareFacilityPortType port = null;
		try {
			port = locator.getHealthCareFacilityPortTypePort(getEndpointReference());
		} catch (Exception e) {
