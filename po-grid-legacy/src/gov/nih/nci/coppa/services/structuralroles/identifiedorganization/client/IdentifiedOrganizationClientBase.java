 ...
 */
public abstract class IdentifiedOrganizationClientBase extends ServiceSecurityClient {	
	protected IdentifiedOrganizationPortType portType;
	...
	public IdentifiedOrganizationClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public IdentifiedOrganizationClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected IdentifiedOrganizationPortType createPortType() throws RemoteException {

		IdentifiedOrganizationServiceAddressingLocator locator = new IdentifiedOrganizationServiceAddressingLocator();
		...
		IdentifiedOrganizationPortType port = null;
		try {
			port = locator.getIdentifiedOrganizationPortTypePort(getEndpointReference());
		} catch (Exception e) {
