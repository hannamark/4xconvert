 ...
 * 
 */
public abstract class OversightCommitteeResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(OversightCommitteeResourceBase.class);

	private OversightCommitteeResourceConfiguration configuration;
    ...
    public OversightCommitteeResourceBase() {
    }
	...
	public OversightCommitteeResourceConfiguration getConfiguration() {
		...
		servicePath+="/OversightCommittee";
		...
		try {
			...
			this.configuration = (OversightCommitteeResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
