 ...
 * 
 */
public abstract class HealthCareProviderResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(HealthCareProviderResourceBase.class);

	private HealthCareProviderResourceConfiguration configuration;
    ...
    public HealthCareProviderResourceBase() {
    }
	...
	public HealthCareProviderResourceConfiguration getConfiguration() {
		...
		servicePath+="/HealthCareProvider";
		...
		try {
			...
			this.configuration = (HealthCareProviderResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
