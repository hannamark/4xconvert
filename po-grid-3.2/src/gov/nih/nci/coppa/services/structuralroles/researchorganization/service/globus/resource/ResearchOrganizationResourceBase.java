 ...
 * 
 */
public abstract class ResearchOrganizationResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(ResearchOrganizationResourceBase.class);

	private ResearchOrganizationResourceConfiguration configuration;
    ...
    public ResearchOrganizationResourceBase() {
    }
	...
	public ResearchOrganizationResourceConfiguration getConfiguration() {
		...
		servicePath+="/ResearchOrganization";
		...
		try {
			...
			this.configuration = (ResearchOrganizationResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
