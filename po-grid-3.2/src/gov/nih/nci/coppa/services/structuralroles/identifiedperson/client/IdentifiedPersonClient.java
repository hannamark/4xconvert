...
public class IdentifiedPersonClient extends IdentifiedPersonClientBase implements IdentifiedPersonI {
    ...
    public static void main(String [] args){
        ...
        try{
            ...
            String[] localArgs = new String[] {"-getId", "-playerId", "-playerId2", "-searchRoot", "-searchExt", "-searchStatus"};
    ...
    private static IdentifiedPerson createCriteria() {
        ...
        String searchRoot = helper.getArgument("-searchRoot", null);
        String searchExt = helper.getArgument("-searchExt", null);
        if (searchRoot != null || searchExt != null) {
            II assignedId = new II();
            if (searchExt != null) {
                assignedId.setExtension(searchExt);
            }
            if (searchRoot != null) {
                assignedId.setRoot(searchRoot);
            }

            criteria.setAssignedId(assignedId);
        }

        String searchStatus = helper.getArgument("-searchStatus", null);
        if (criteria.getAssignedId() == null && searchStatus == null) {
            // default to pending if no other criteria specified
            searchStatus = "pending";
        }
        if (searchStatus != null) {
            CD statusCode = new CD();
            statusCode.setCode(searchStatus);
