 ...
 */
public abstract class ClinicalResearchStaffClientBase extends ServiceSecurityClient {	
	protected ClinicalResearchStaffPortType portType;
	...
	public ClinicalResearchStaffClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public ClinicalResearchStaffClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected ClinicalResearchStaffPortType createPortType() throws RemoteException {

		ClinicalResearchStaffServiceAddressingLocator locator = new ClinicalResearchStaffServiceAddressingLocator();
		...
		ClinicalResearchStaffPortType port = null;
		try {
			port = locator.getClinicalResearchStaffPortTypePort(getEndpointReference());
		} catch (Exception e) {
