 ...
 * 
 */
public abstract class PersonResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(PersonResourceBase.class);

	private PersonResourceConfiguration configuration;
	...
	public PersonResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (PersonResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
