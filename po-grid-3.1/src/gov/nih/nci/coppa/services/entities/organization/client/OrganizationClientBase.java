 ...
 */
public abstract class OrganizationClientBase extends ServiceSecurityClient {	
	protected OrganizationPortType portType;
	...
	public OrganizationClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public OrganizationClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected OrganizationPortType createPortType() throws RemoteException {

		OrganizationServiceAddressingLocator locator = new OrganizationServiceAddressingLocator();
		...
		OrganizationPortType port = null;
		try {
			port = locator.getOrganizationPortTypePort(getEndpointReference());
		} catch (Exception e) {
