 ...
 * 
 */
public abstract class SubjectAccrualServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(SubjectAccrualServiceResourceBase.class);

	private SubjectAccrualServiceResourceConfiguration configuration;
    ...
    public SubjectAccrualServiceResourceBase() {
    }
	...
	public SubjectAccrualServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/SubjectAccrualService";
		...
		try {
			...
			this.configuration = (SubjectAccrualServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
