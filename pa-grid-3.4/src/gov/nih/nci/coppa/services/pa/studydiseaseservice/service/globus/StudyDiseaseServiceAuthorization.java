 ...
 * 
 */
public class StudyDiseaseServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyDiseaseService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyDiseaseServiceAuthorization() {
	}
