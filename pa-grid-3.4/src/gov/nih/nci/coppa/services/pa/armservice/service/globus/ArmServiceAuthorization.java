 ...
 * 
 */
public class ArmServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/ArmService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ArmServiceAuthorization() {
	}
