 ...
 * 
 */
public abstract class RegulatoryAuthorityServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(RegulatoryAuthorityServiceResourceBase.class);

	private RegulatoryAuthorityServiceResourceConfiguration configuration;
    ...
    public RegulatoryAuthorityServiceResourceBase() {
    }
	...
	public RegulatoryAuthorityServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/RegulatoryAuthorityService";
		...
		try {
			...
			this.configuration = (RegulatoryAuthorityServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
