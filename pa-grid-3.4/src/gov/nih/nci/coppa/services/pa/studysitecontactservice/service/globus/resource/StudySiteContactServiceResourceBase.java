 ...
 * 
 */
public abstract class StudySiteContactServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudySiteContactServiceResourceBase.class);

	private StudySiteContactServiceResourceConfiguration configuration;
    ...
    public StudySiteContactServiceResourceBase() {
    }
	...
	public StudySiteContactServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudySiteContactService";
		...
		try {
			...
			this.configuration = (StudySiteContactServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
