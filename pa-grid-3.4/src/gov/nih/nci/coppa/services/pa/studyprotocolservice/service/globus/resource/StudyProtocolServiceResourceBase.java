 ...
 * 
 */
public abstract class StudyProtocolServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyProtocolServiceResourceBase.class);

	private StudyProtocolServiceResourceConfiguration configuration;
    ...
    public StudyProtocolServiceResourceBase() {
    }
	...
	public StudyProtocolServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyProtocolService";
		...
		try {
			...
			this.configuration = (StudyProtocolServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
