...
public class StudyResourcingServiceAuthorization implements PDP {
	...
	public void authorizeGetSummary4ReportedResourcing(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getSummary4ReportedResourcing")){
			authorizeGetSummary4ReportedResourcing(peerSubject, context, operation);
			return true;
