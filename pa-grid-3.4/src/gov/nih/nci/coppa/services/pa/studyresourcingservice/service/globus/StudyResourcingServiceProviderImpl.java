...
public class StudyResourcingServiceProviderImpl{
    ...
    public gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingResponse getSummary4ReportedResourcing(gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingRequest params) throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
    gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingResponse boxedResult = new gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingResponse();
    boxedResult.setStudyResourcing(impl.getSummary4ReportedResourcing(params.getStudyProtocolId().getId()));
    return boxedResult;
  }
