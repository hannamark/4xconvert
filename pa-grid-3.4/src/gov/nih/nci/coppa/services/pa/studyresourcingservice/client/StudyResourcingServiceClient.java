...
public class StudyResourcingServiceClient extends StudyResourcingServiceClientBase implements StudyResourcingServiceI {
    ...
    private static void getSummaryByProtocolId(StudyResourcingServiceClient client) throws RemoteException, PAFault {
        ...
        StudyResourcing[] results = client.getSummary4ReportedResourcing(id);        
        if (results == null) {
  ...
  public gov.nih.nci.coppa.services.pa.StudyResourcing[] getSummary4ReportedResourcing(gov.nih.nci.iso21090.extensions.Id studyProtocolId) throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
    synchronized(portTypeMutex){
      configureStubSecurity((Stub)portType,"getSummary4ReportedResourcing");
    gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingRequest params = new gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingRequest();
    gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingRequestStudyProtocolId studyProtocolIdContainer = new gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingRequestStudyProtocolId();
    studyProtocolIdContainer.setId(studyProtocolId);
    params.setStudyProtocolId(studyProtocolIdContainer);
    gov.nih.nci.coppa.services.pa.studyresourcingservice.stubs.GetSummary4ReportedResourcingResponse boxedResult = portType.getSummary4ReportedResourcing(params);
