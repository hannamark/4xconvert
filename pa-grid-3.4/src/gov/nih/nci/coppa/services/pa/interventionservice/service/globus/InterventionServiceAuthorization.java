 ...
 * 
 */
public class InterventionServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/InterventionService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public InterventionServiceAuthorization() {
	}
