 ...
 * 
 */
public abstract class StudyParticipationContactServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyParticipationContactServiceResourceBase.class);

	private StudyParticipationContactServiceResourceConfiguration configuration;
    ...
    public StudyParticipationContactServiceResourceBase() {
    }
	...
	public StudyParticipationContactServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyParticipationContactService";
		...
		try {
			...
			this.configuration = (StudyParticipationContactServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
