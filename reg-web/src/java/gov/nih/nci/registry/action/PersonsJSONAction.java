...
public class PersonsJSONAction extends ActionSupport {
    ...
    public String getPrincipalInvestigatorsByNameAssociatedWithStudyProtocol() {
        String personTerm = (String) (ServletActionContext.getRequest().getParameter("personTerm"));
        ...
        for (PaPersonDTO personDto : personDtos) {
        	getPaPersonDTOs().put(String.valueOf(personDto.getId()), personDto.getFullName());
        }
        return SUCCESS;
    }
