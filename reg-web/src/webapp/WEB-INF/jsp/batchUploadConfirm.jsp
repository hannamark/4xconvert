...
<head>
    <title><fmt:message key="batch.upload.confirm.page.title"/></title>   
    <s:head/>
</head>
...
<!-- main content begins-->
    ...
    <div class="box" id="filters">
      ...
      Please <a href="${pageContext.request.contextPath}/admin/batchUploadprocess.action">click here</a> to submit another file. 
 </div>
