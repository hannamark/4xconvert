...
<body>
	...
	<c:set var="topic" scope="request" value="ctimport" />
		<s:form id="importCtGovForm" cssClass="form-horizontal" role="form">
            ...
            <p align="center">To register a trial under the Industrial/Other submission category in CTRP, please enter the ClinicalTrials.gov identifier below and click <b>Search Studies</b>.
