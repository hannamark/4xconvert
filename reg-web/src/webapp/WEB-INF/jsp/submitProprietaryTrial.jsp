            ...
            <s:form name="submitProprietaryTrial" method="POST" enctype="multipart/form-data">
                ...
                <table class="form">
                    ...
                    <tr>
                        <td scope="row" class="label">
                            <reg-web:displayTooltip tooltip="tooltip.summary_4_program_code">
                                <label for="siteProgramCode"><fmt:message key="submit.proprietary.trial.sitePrgCode"/></label>
                            </reg-web:displayTooltip>
                        </td>
                        <td class="value">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            <td scope="row" class="label">
                                <label for="submitTrial_overallStatusWebDTO_statusDate"><fmt:message key="submit.trial.siteRecruitmentStatusDate" /><span class="required">*</span></label>
                            </td>
                            <td class="value"><s:textfield name="trialDTO.siteStatusDate" maxlength="10" size="10" cssStyle="width:70px;float:left"/>
                        ...
                        <tr>
                            <td scope="row" class="label">
                                <label for="submitTrial_protocolWebDTO_startDate"><fmt:message key="submit.proprietary.trial.dateOpenedforAccrual" /></label>
                            </td>
                            <td class="value">
                        ...
                        <tr>
                            <td scope="row" class="label">
                                <label for="submitTrial_protocolWebDTO_completionDate"><fmt:message key="submit.proprietary.trial.dateClosedforAccrual" /></label>
                            </td>
                            <td class="value">
