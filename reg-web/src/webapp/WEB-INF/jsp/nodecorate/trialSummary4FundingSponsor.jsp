...
<div class="col-xs-12">
	...
	<div class="col-xs-6">
	    <button onclick="deleteSummary4SponsorRow('<c:out value="${summaryFourOrgIdentifiers.rowId}" />');" title="Remove this Summary4 Sponsor" type="button" class="btn btn-icon btn-default"><i class="fa-minus"></i>Delete Sponsor</button>
	</div> 
	<div>
    <br>
    <br>
