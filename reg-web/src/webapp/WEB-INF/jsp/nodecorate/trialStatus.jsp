...
<tr>
    <td scope="row" class="label">
        <label for="updateTrial_statusCode">
            <fmt:message key="update.trial.currentTrialStatus" /><span class="required">*</span>
        </label>
    </td>
...
<tr>
    <td scope="row" class="label">
        <label for="updateTrial_reason">
            <fmt:message key="update.trial.trialStatusReason" />
        </label>
    </td>
    <td>
...
<tr>
    <td scope="row" class="label">
        <label for="updateTrial_statusDate">
            <fmt:message key="update.trial.currentTrialStatusDate" /><span class="required">*</span>
        </label>
    </td>
    <td class="value">
...
<tr>
    <td scope="row" class="label">
        <label for="updateTrial_startDate">
            <fmt:message key="update.trial.trialStartDate" /><span class="required">*</span>
        </label>
    </td>
    <td class="value">
...
<tr>
    <td scope="row" class="label">
        <label for="updateTrial_completionDate">
            <fmt:message key="update.trial.primaryCompletionDate" /><span class="required">*</span>
        </label>
    </td>
    <td class="value">
