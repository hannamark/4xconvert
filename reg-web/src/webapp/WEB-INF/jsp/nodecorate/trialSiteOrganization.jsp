...
<td class="value">
    <ul style="margin-top:-5px;">              
        <li style="padding-left:0">
         <a href="#" class="btn" onclick="lookup4loadSiteOrg();" title="Opens a popup form to select Site Organization"/><span class="btn_img"><span class="organization">Look Up Org</span></span></a>
        </li>
    </ul>
</td>
</tr>
