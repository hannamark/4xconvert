...
<div class="form-group">
    <label class="col-xs-4 control-label"><fmt:message key="regulatory.oversight.auth.name"/><span class="required">*</span>
    </label>
    <div class="col-xs-4">
...
<div class="form-group">
    <label class="col-xs-4 control-label"><fmt:message key="regulatory.FDA.regulated.interv.ind"/><span class="required">*</span>
    </label>
    <div class="col-xs-4">
...
<div class="form-group">
    <label class="col-xs-4 control-label"><fmt:message key="regulatory.section801.ind"/><span class="required">*</span>
    </label>
    <div class="col-xs-4">
...
<div class="form-group">
    <label class="col-xs-4 control-label"><fmt:message key="regulatory.delayed.posting.ind"/><span class="required">*</span>
    </label>
    <div class="col-xs-4">
