...
<table  class="form">  
   ...
   <td>
    ...
    <td scope="row" class="label"><label for="poOrganizations_createOrg_orgZip;">ZIP :</label></td><td><s:textfield id="orgZip" name="createOrg.orgZip;" maxlength="20" size="100"  cssStyle="width:200px" /></td>
