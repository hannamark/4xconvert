...
<table  class="form">  
   ...
   <tr>        
 		...
 		<td scope="row" class="label"><label for="poOrganizations_createOrg_orgState">State :<br></label></td><td><s:textfield name="createOrg.orgState"  maxlength="200" size="100"  cssStyle="width:200px" /><br><span class="tiny">(2-letter State/Province Code required for USA/Canada/Australia)</span></td>
   </tr>
   <tr>     
