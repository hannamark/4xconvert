    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            function updateOwnership(assignOwnership) {
                ...
                form.action = (assignOwnership) ? "manageTrialOwnershipassignOwnership.action" : "manageTrialOwnershipunassignOwnership.action";
                form.submit();
            }
            
            function updateRegUser(regUserId) {
                var  url = '/registry/protected/manageTrialOwnershipsetRegUser.action';
                var params = {
            ...
            function updateTrial(trialId) {
                var  url = '/registry/protected/manageTrialOwnershipsetTrial.action';
                var params = {
