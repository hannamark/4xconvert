 ...
 * 
 */
public abstract class StudyOnholdServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyOnholdServiceResourceBase.class);

	private StudyOnholdServiceResourceConfiguration configuration;
    ...
    public StudyOnholdServiceResourceBase() {
    }
	...
	public StudyOnholdServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyOnholdService";
		...
		try {
			...
			this.configuration = (StudyOnholdServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
