 ...
 * 
 */
public abstract class DocumentServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(DocumentServiceResourceBase.class);

	private DocumentServiceResourceConfiguration configuration;
    ...
    public DocumentServiceResourceBase() {
    }
	...
	public DocumentServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (DocumentServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
