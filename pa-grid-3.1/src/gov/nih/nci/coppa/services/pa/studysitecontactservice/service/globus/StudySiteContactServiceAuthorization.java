 ...
 * 
 */
public class StudySiteContactServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudySiteContactService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudySiteContactServiceAuthorization() {
	}
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("copy")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getByStudySite")){
			authorizeGetByStudySite(peerSubject, context, operation);
			return true;
