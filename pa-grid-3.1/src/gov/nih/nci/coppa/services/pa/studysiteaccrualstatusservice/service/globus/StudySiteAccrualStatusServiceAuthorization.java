 ...
 * 
 */
public class StudySiteAccrualStatusServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudySiteAccrualStatusService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudySiteAccrualStatusServiceAuthorization() {
	}
	...
	public void authorizeGetStudySiteAccrualStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeCreateStudySiteAccrualStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeUpdateStudySiteAccrualStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getStudySiteAccrualStatus")){
			authorizeGetStudySiteAccrualStatus(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("createStudySiteAccrualStatus")){
			authorizeCreateStudySiteAccrualStatus(peerSubject, context, operation);
			return true;
