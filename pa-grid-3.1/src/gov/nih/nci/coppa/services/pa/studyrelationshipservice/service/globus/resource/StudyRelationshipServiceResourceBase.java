 ...
 * 
 */
public abstract class StudyRelationshipServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyRelationshipServiceResourceBase.class);

	private StudyRelationshipServiceResourceConfiguration configuration;
    ...
    public StudyRelationshipServiceResourceBase() {
    }
	...
	public StudyRelationshipServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyRelationshipService";
		...
		try {
			...
			this.configuration = (StudyRelationshipServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
