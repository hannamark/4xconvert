 ...
 * 
 */
public class IdentifiedPersonAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/IdentifiedPerson";
	
	Map authorizationClassMap = new HashMap();
	
	
	public IdentifiedPersonAuthorization() {
	}
