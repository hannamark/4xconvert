 ...
 * 
 */
public abstract class ClinicalResearchStaffResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ClinicalResearchStaffResourceBase.class);

	private ClinicalResearchStaffResourceConfiguration configuration;
    ...
    public ClinicalResearchStaffResourceBase() {
    }
	...
	public ClinicalResearchStaffResourceConfiguration getConfiguration() {
		...
		servicePath+="/ClinicalResearchStaff";
		...
		try {
			...
			this.configuration = (ClinicalResearchStaffResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
