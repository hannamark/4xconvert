 ...
 * 
 */
public class OrganizationalContactAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/OrganizationalContact";
	
	Map authorizationClassMap = new HashMap();
	
	
	public OrganizationalContactAuthorization() {
	}
