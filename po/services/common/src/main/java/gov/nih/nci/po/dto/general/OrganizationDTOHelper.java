 ...
 * 
 * This is the helper class for the gov.nih.nci.po.dto.general.OrganizationDTO snapshot class.
 */
...
public class OrganizationDTOHelper implements SnapshotHelper {
  ...
  public Object createSnapshot(Object model, TransformContext context) throws XSnapshotException {
    if (model == null) {
      ...
      if (myClass.isInstance (model)) {
        ...
        Object existingSnapshot = context.getSnapshotInstance (model, "general");
        if (existingSnapshot != null) {
          return existingSnapshot;
        }
        else {
          gov.nih.nci.po.dto.general.OrganizationDTO snapshot = new gov.nih.nci.po.dto.general.OrganizationDTO();
          context.setSnapshotInstance (model, "general", snapshot);  
  ...
  public Object createModel(Object snapshot, TransformContext context) throws XSnapshotException {
    if (snapshot == null) {
      ...
      Class myClass = gov.nih.nci.po.dto.general.OrganizationDTO.class;
      if (myClass.isInstance (snapshot)) {
        ...
        if (existingModel != null) {
         ...
         throw new IllegalArgumentException ("snapshot object is of class " + snapshot.getClass () + " which is not a subclass of gov.nih.nci.po.dto.general.OrganizationDTO");
      }
    }     
  }

  /**
    * Copies a gov.nih.nci.po.data.bo.Organization model object into a gov.nih.nci.po.dto.general.OrganizationDTO snapshot object
  ...
  public void copyIntoSnapshot (Object model, Object snapshot, TransformContext context) throws XSnapshotException {
    ...
    SnapshotHelper parentSnapshotHelper = context.getHelperForModel (gov.nih.nci.po.data.common.AbstractOrganization.class, "general");
    parentSnapshotHelper.copyIntoSnapshot (model, snapshot, context);
    gov.nih.nci.po.dto.general.OrganizationDTO snapshotCasted = (gov.nih.nci.po.dto.general.OrganizationDTO) snapshot;
