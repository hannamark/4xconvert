...
// appropriately
   ...
   */
  public static OrganizationDTO createSnapshot(gov.nih.nci.po.data.bo.Organization model, XSnapshotRegistry registry) throws XSnapshotException {
    return (OrganizationDTO) XSnapshotUtils.createSnapshot(model, "general", registry);
  }
  /**
   ...
   * or if an XSnapshot error occurs during conversion
   */
  public static void copyIntoSnapshot(gov.nih.nci.po.data.bo.Organization model, OrganizationDTO snapshot, XSnapshotRegistry registry) throws XSnapshotException {
   ...
   */
  public static OrganizationDTO[] createSnapshotArray(Collection modelCollection, XSnapshotRegistry registry) throws XSnapshotException {
    return (OrganizationDTO[]) XSnapshotUtils.createSnapshotArray (modelCollection, "general", new OrganizationDTO[modelCollection.size()], registry);
  }
  /**
   ...
   * or if an XSnapshot error occurs during conversion
   */
  public static gov.nih.nci.po.data.bo.Organization createModel(OrganizationDTO snapshot, XSnapshotRegistry registry) throws XSnapshotException {
    return (gov.nih.nci.po.data.bo.Organization) XSnapshotUtils.createModel(snapshot, registry);
  }
  /**
   * copy the given model object into the given snapshot object
   * @param model the model object
   ...
   * or if an XSnapshot error occurs during conversion
   */
  public static void copyIntoModel(OrganizationDTO snapshot, gov.nih.nci.po.data.bo.Organization model, XSnapshotRegistry registry) throws XSnapshotException {
   ...
   * @return the list of model objects
   */
  public static gov.nih.nci.po.data.bo.Organization[] createModelArray(Collection snapshotCollection, XSnapshotRegistry registry) throws XSnapshotException {  
    return (gov.nih.nci.po.data.bo.Organization[]) XSnapshotUtils.createModelArray (snapshotCollection, new gov.nih.nci.po.data.bo.Organization[snapshotCollection.size()], registry);
  }
