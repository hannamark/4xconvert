...
<ajax:displayTag id="roleSearchResults" tableClass="data">
    <display:table class="data" sort="list" pagesize="${initParam['defaultPageSize']}" uid="row" name="results" requestURI="${sortUrl}" >
        ...
        <display:column titleKey="healthCareProvider.scoper.name" property="scoper.name" sortable="false" sortProperty="SCOPER_NAME" maxLength="30"/>
        ...
        <display:column titleKey="th.action" class="action">
            ...
            <po:buttonRow>
                <po:button href="${editUrl}" style="edit" text="Edit" id="edit_healthCareProvider_id_${row.id}"/>
            </po:buttonRow>
        </display:column>
    </display:table>
</ajax:displayTag>
