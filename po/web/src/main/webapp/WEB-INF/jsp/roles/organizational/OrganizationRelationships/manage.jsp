...
<html>
<head>
<title><s:text name="organizationRelationships.manage.title"/></title>
</head> 
<body>
...
<po:successMessages/>
    ...
    <div class="boxouter">
    <h2><s:text name="organizationRelationships.manage.title"/> Information</h2>
        <%@ include file="../orgInfo.jsp" %>
        <div class="boxouter">
        <h2><s:text name="organizationRelationships.manage.title"/>(s)</h2>
            <div id="roles">
