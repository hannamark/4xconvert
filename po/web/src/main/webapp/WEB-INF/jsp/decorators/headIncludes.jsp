...
<script type="text/javascript" language="javascript" src="<c:url value="/scripts/scriptaculous/controls.js"/>"></script>
<script type="text/javascript" language="javascript" src="<c:url value="/scripts/scriptaculous/dragdrop.js"/>"></script>
