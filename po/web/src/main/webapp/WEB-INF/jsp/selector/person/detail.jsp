...
<div class="btnwrapper">
	<po:buttonRow>
	    ...
	    <po:button href="javascript://nop/" onclick="markAsDuplicate(new IdValue('${person.id}', '${person.lastName}, ${person.firstName} ${person.middleName}'));" style="reject" text="Select" />
	</po:buttonRow>
</div>