...
public class OrganizationTelecomAddressTest extends AbstractOrganizationEntityService  {
	...
	private OrganizationDTO createOrgDTO(String name, Ad postalAddress, DSet<Tel> telecomAddress) throws URISyntaxException {
	...
	private static boolean testDataLoaded = false;
	 @Before
	    public void loadData() throws Exception {
         ...
         String state = "WY";
         remoteCreateAndCatalog(createOrgDTO("WEE Org Inc. I", RemoteApiUtils.createAd("123 abc ave.", null, "mycity",
                 state, "12345", "USA"), telecomAddress));
         DSet<Tel> telecomAddress1 = RemoteApiUtils.convertToDSetTel(Arrays.asList(new String[] { "myorg@myorg.com"})
        		 ,Arrays.asList(new String[] { "+1 342 453 5655"}), Arrays.asList(new String[] { "+1 603.123.4567 ext 204"}),
        		 Arrays.asList(new String[] { "http://testmail.org.com"}), null);
         remoteCreateAndCatalog(createOrgDTO("ZEE Org Inc. I", RemoteApiUtils.createAd("123 abc ave.", null, "mycity",
                 state, "12345", "USA"), telecomAddress1));
         testDataLoaded = true;
		 }
	 }
	 @Test
	    public void findByTelcomAddressByPhoneEmailUrl() {
	        ...
	        List<String> email = Arrays.asList(new String[] { "myorg@myorg.com" });
	 ...
	 @Test
	 public void findTelcomAddressOnlyByEmailStartWith() {
	        List<String> email = Arrays.asList(new String[] { "myorg"});
	        DSet<Tel> telecomAddress = RemoteApiUtils.convertToDSetTel(email, null, null, null, null);
	    	OrganizationDTO p = new OrganizationDTO();
	        p.setTelecomAddress(telecomAddress);
	        List<OrganizationDTO> results = getOrgService().search(p);
	 ...
	 public void findTelcomAddressOnlyByEmailSubString() {
	        List<String> email = Arrays.asList(new String[] { "org"});
	        DSet<Tel> telecomAddress = RemoteApiUtils.convertToDSetTel(email, null, null, null, null);
	    	OrganizationDTO p = new OrganizationDTO();
	        p.setTelecomAddress(telecomAddress);
	        List<OrganizationDTO> results = getOrgService().search(p);
	...
	@Test
	 ...
	 @Test
	 public void findTelcomAddressOnlyByUrlStartWith() {
	 ...
	 public void findTelcomAddressOnlyByUrlSubString() {
		try {
			...
			DSet<Tel> telecomAddress = RemoteApiUtils.convertToDSetTel(null,
					null, null, url, null);
			fail();
	 ...
	 public void createTelcomAddressOnlyByEmailNotValid() {
	        ...
	        DSet<Tel> telecomAddress = RemoteApiUtils.convertToDSetTel(email, null, null, null, null);
	        try {
				remoteCreateAndCatalog(createOrgDTO("In valid email id", RemoteApiUtils.createAd("123 abc ave.", null, "mycity",
				         "MD", "12345", "USA"), telecomAddress));
				fail();
	 ...
	 public void createTelcomAddressOnlyByPhoneNotValid() {
	        ...
	        try {
				remoteCreateAndCatalog(createOrgDTO("In valid phone-23o4n", RemoteApiUtils.createAd("123 abc ave.", null, "mycity",
				         "MD", "12345", "USA"), telecomAddress));
				//fail();
	        } catch (EntityValidationException e) {
