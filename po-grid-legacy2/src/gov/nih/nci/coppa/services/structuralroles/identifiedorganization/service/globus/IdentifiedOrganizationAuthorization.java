 ...
 * 
 */
public class IdentifiedOrganizationAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/IdentifiedOrganization";
	
	Map authorizationClassMap = new HashMap();
	
	
	public IdentifiedOrganizationAuthorization() {
	}
	...
	public void authorizeGetByIds(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeUpdateStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeGetByIds(peerSubject, context, operation);
			return true;
			...
			authorizeUpdateStatus(peerSubject, context, operation);
			return true;
