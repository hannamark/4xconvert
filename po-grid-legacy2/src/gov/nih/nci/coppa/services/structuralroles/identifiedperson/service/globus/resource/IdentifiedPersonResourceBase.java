 ...
 * 
 */
public abstract class IdentifiedPersonResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(IdentifiedPersonResourceBase.class);

	private IdentifiedPersonResourceConfiguration configuration;
    ...
    public IdentifiedPersonResourceBase() {
    }
	...
	public IdentifiedPersonResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (IdentifiedPersonResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
