 ...
 * 
 */
public class RegulatoryAuthorityServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/RegulatoryAuthorityService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public RegulatoryAuthorityServiceAuthorization() {
	}
