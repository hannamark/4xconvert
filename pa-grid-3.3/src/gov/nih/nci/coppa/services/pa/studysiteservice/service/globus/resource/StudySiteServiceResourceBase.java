 ...
 * 
 */
public abstract class StudySiteServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudySiteServiceResourceBase.class);

	private StudySiteServiceResourceConfiguration configuration;
    ...
    public StudySiteServiceResourceBase() {
    }
	...
	public StudySiteServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (StudySiteServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
