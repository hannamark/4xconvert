...
public class StudySiteParticipationServiceClient extends StudySiteParticipationServiceClientBase implements
        ...
        try {
            if (!(args.length < 2)) {
                if (args[0].equals("-url")) {
                    ...
                    getParticipatingSitesByStudyProtocol(client);
                } else {
                    usage();
                    System.exit(1);
                }
    ...
    private static void createPropSite(StudySiteParticipationServiceClient client) throws DtoTransformException,
        ...
        studyProtocolIi.setExtension("NCI-2010-00031"); // Use existing Study Protocol Ii
    ...
    private static void getParticipatingSitesByStudyProtocol(StudySiteParticipationServiceClient client) throws PAFault, RemoteException {
        Id studyProtocolId = new Id();
        studyProtocolId.setExtension("NCI-2010-00031"); // Use existing Study Protocol Ii
        ...
        System.out.println("search found " + results.length + " study participating site based on source protocol");
