 ...
 * 
 */
public class CoreServicesAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/CoreServices";
	
	
	public CoreServicesAuthorization() {
	}
