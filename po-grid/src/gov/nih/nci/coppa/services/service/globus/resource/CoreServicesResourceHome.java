 ...
 * 
 */
public class CoreServicesResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CoreServicesResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    CoreServicesResourceProperties props = new CoreServicesResourceProperties();
			CoreServicesResource resource = new CoreServicesResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, CoreServicesConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, CoreServicesConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CoreServicesResource resource = (CoreServicesResource) super.find(key);
		return resource;
	}
     ...
     */
    public CoreServicesResource getAddressedResource() throws Exception {
        CoreServicesResource thisResource;
        thisResource = (CoreServicesResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}