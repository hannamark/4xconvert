 ...
 * 
 */
public abstract class OrganizationResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(OrganizationResourceBase.class);

	private OrganizationResourceConfiguration configuration;
    ...
    public OrganizationResourceBase() {
    }
	...
	public OrganizationResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (OrganizationResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
