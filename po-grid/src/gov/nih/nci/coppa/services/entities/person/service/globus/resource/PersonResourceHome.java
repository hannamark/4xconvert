...
import gov.nih.nci.coppa.services.entities.person.common.PersonConstants;
import gov.nih.nci.coppa.services.entities.person.stubs.PersonResourceProperties;
...
public class PersonResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		PersonResourceProperties props = new PersonResourceProperties();
        ...
        resource.initialize(props, PersonConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public gov.nih.nci.coppa.services.entities.person.stubs.types.PersonReference getResourceReference(ResourceKey key) throws Exception {
		MessageContext ctx = MessageContext.getCurrentContext();
		String transportURL = (String) ctx.getProperty(org.apache.axis.MessageContext.TRANS_URL);
		transportURL = transportURL.substring(0,transportURL.lastIndexOf('/') +1 );
		transportURL += "Person";
		EndpointReferenceType epr = AddressingUtils.createEndpointReference(transportURL,key);
		gov.nih.nci.coppa.services.entities.person.stubs.types.PersonReference ref = new gov.nih.nci.coppa.services.entities.person.stubs.types.PersonReference();
 	...
 	*/	
	public PersonResource getResource(ResourceKey key) throws ResourceException {
		PersonResource thisResource = (PersonResource)find(key);
		return thisResource;
	}
     ...
     */
    public PersonResource getAddressedResource() throws Exception {
        PersonResource thisResource;
        thisResource = (PersonResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
