 ...
 * 
 */
public abstract class BusinessResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(BusinessResourceBase.class);

	private BusinessResourceConfiguration configuration;
	...
	public BusinessResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (BusinessResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
