 ...
 * 
 */
public abstract class PatientResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(PatientResourceBase.class);

	private PatientResourceConfiguration configuration;
	...
	public PatientResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (PatientResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
