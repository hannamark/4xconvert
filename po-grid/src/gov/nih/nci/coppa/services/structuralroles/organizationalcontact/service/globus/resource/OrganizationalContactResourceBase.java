 ...
 * 
 */
public abstract class OrganizationalContactResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(OrganizationalContactResourceBase.class);

	private OrganizationalContactResourceConfiguration configuration;
    ...
    public OrganizationalContactResourceBase() {
    }
	...
	public OrganizationalContactResourceConfiguration getConfiguration() {
		...
		servicePath+="/OrganizationalContact";
		...
		try {
			...
			this.configuration = (OrganizationalContactResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
