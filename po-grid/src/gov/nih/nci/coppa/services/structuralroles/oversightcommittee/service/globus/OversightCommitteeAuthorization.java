 ...
 * 
 */
public class OversightCommitteeAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/OversightCommittee";
	
	Map authorizationClassMap = new HashMap();
	
	
	public OversightCommitteeAuthorization() {
	}
