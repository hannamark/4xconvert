 ...
 */
public abstract class OversightCommitteeClientBase extends ServiceSecurityClient {	
	protected OversightCommitteePortType portType;
	...
	public OversightCommitteeClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public OversightCommitteeClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected OversightCommitteePortType createPortType() throws RemoteException {

		OversightCommitteeServiceAddressingLocator locator = new OversightCommitteeServiceAddressingLocator();
		...
		OversightCommitteePortType port = null;
		try {
			port = locator.getOversightCommitteePortTypePort(getEndpointReference());
		} catch (Exception e) {
