...
public abstract class HealthCareFacilityResourceBase extends ReflectionResource implements Resource
    ...
    public HealthCareFacilityResourceBase() {
    }
	...
	public HealthCareFacilityResourceConfiguration getConfiguration() {
		...
		servicePath+="/HealthCareFacility";
		...
		try {
			...
			this.configuration = (HealthCareFacilityResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
