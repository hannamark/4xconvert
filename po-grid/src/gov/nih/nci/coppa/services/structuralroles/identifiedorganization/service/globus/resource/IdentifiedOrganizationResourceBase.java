 ...
 * 
 */
public abstract class IdentifiedOrganizationResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(IdentifiedOrganizationResourceBase.class);

	private IdentifiedOrganizationResourceConfiguration configuration;
    ...
    public IdentifiedOrganizationResourceBase() {
    }
	...
	public IdentifiedOrganizationResourceConfiguration getConfiguration() {
		...
		servicePath+="/IdentifiedOrganization";
		...
		try {
			...
			this.configuration = (IdentifiedOrganizationResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
