 ...
 * 
 */
public class ResearchOrganizationAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/ResearchOrganization";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ResearchOrganizationAuthorization() {
	}
