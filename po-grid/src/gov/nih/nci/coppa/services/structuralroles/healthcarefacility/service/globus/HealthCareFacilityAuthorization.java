 ...
 * 
 */
public class HealthCareFacilityAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/structuralroles/HealthCareFacility";
	
	Map authorizationClassMap = new HashMap();
	
	
	public HealthCareFacilityAuthorization() {
	}
