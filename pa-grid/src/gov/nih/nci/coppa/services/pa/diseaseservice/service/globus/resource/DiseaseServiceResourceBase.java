 ...
 * 
 */
public abstract class DiseaseServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(DiseaseServiceResourceBase.class);

	private DiseaseServiceResourceConfiguration configuration;
    ...
    public DiseaseServiceResourceBase() {
    }
	...
	public DiseaseServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (DiseaseServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
