 ...
 * 
 */
public abstract class StudyRecruitmentStatusServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyRecruitmentStatusServiceResourceBase.class);

	private StudyRecruitmentStatusServiceResourceConfiguration configuration;
    ...
    public StudyRecruitmentStatusServiceResourceBase() {
    }
	...
	public StudyRecruitmentStatusServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyRecruitmentStatusService";
		...
		try {
			...
			this.configuration = (StudyRecruitmentStatusServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
