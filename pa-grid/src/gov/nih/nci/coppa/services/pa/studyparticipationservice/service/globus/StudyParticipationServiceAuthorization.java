 ...
 * 
 */
public class StudyParticipationServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyParticipationService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyParticipationServiceAuthorization() {
	}
