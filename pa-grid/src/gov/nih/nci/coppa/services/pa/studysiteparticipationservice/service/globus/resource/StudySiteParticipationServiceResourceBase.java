 ...
 * 
 */
public abstract class StudySiteParticipationServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudySiteParticipationServiceResourceBase.class);

	private StudySiteParticipationServiceResourceConfiguration configuration;
    ...
    public StudySiteParticipationServiceResourceBase() {
    }
	...
	public StudySiteParticipationServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudySiteParticipationService";
		...
		try {
			...
			this.configuration = (StudySiteParticipationServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
