 ...
 * 
 */
public class DocumentServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/DocumentService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public DocumentServiceAuthorization() {
	}
