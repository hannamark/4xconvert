 ...
 * 
 */
public abstract class StudyOutcomeMeasureServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyOutcomeMeasureServiceResourceBase.class);

	private StudyOutcomeMeasureServiceResourceConfiguration configuration;
    ...
    public StudyOutcomeMeasureServiceResourceBase() {
    }
	...
	public StudyOutcomeMeasureServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyOutcomeMeasureService";
		...
		try {
			...
			this.configuration = (StudyOutcomeMeasureServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
