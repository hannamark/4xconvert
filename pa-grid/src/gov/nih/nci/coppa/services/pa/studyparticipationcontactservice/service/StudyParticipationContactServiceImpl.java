...
public class StudyParticipationContactServiceImpl extends StudyParticipationContactServiceImplBase {
   ...
   * {@inheritDoc}
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact[]
        getByStudyParticipation(gov.nih.nci.coppa.services.pa.Id studyParticipationId)
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact[]
           getByStudyProtocolAndRole(gov.nih.nci.coppa.services.pa.Id studyProtocolId,
           gov.nih.nci.coppa.services.pa.StudyParticipationContact studyParticipationContact)
             throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      StudyParticipationContact[] result = null;
      try {
          Ii iiDto = IITransformer.INSTANCE.toDto(studyProtocolId);
          StudyParticipationContactDTO spcDto = StudyParticipationContactTransformer.INSTANCE.toDto(studyParticipationContact);
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact[]
      getByStudyProtocolAndRoles(gov.nih.nci.coppa.services.pa.Id studyProtocolId,
      gov.nih.nci.coppa.services.pa.StudyParticipationContact studyParticipationContact)
          throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact[]
      getByStudyProtocol(gov.nih.nci.coppa.services.pa.Id id)
          throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      StudyParticipationContact[] result = null;
      try {
  ...
  public void copy(gov.nih.nci.coppa.services.pa.Id fromStudyProtocolId,
        gov.nih.nci.coppa.services.pa.Id toStudyProtocolId)
          throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact[]
      getCurrentByStudyProtocol(gov.nih.nci.coppa.services.pa.Id studyProtocolId)
        throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      StudyParticipationContact[] result = null;
      try {
          Ii iiDto = IITransformer.INSTANCE.toDto(studyProtocolId);
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact
          get(gov.nih.nci.coppa.services.pa.Id id)
          throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      try {
          Ii iiDto = IITransformer.INSTANCE.toDto(id);
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact
          create(gov.nih.nci.coppa.services.pa.StudyParticipationContact studyParticipationContact)
          throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      throw new RemoteException("Not yet implemented");
  }
  /**
   ...
   */
  public gov.nih.nci.coppa.services.pa.StudyParticipationContact
      update(gov.nih.nci.coppa.services.pa.StudyParticipationContact studyParticipationContact)
      throws RemoteException, gov.nih.nci.coppa.services.pa.faults.PAFault {
      throw new RemoteException("Not yet implemented");
  }
