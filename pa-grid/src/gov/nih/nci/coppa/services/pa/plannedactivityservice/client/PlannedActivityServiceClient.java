...
public class PlannedActivityServiceClient extends PlannedActivityServiceClientBase implements PlannedActivityServiceI {	
	...
	public PlannedActivityServiceClient(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	}
	...
	public PlannedActivityServiceClient(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
	}
