 ...
 * 
 */
public abstract class StudyRegulatoryAuthorityServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyRegulatoryAuthorityServiceResourceBase.class);

	private StudyRegulatoryAuthorityServiceResourceConfiguration configuration;
    ...
    public StudyRegulatoryAuthorityServiceResourceBase() {
    }
	...
	public StudyRegulatoryAuthorityServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyRegulatoryAuthorityService";
		...
		try {
			...
			this.configuration = (StudyRegulatoryAuthorityServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
