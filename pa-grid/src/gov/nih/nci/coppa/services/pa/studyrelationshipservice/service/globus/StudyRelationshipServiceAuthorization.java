 ...
 * 
 */
public class StudyRelationshipServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyRelationshipService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyRelationshipServiceAuthorization() {
	}
