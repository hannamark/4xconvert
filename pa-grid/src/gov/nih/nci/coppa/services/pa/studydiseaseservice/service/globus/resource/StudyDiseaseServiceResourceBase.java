 ...
 * 
 */
public abstract class StudyDiseaseServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyDiseaseServiceResourceBase.class);

	private StudyDiseaseServiceResourceConfiguration configuration;
    ...
    public StudyDiseaseServiceResourceBase() {
    }
	...
	public StudyDiseaseServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyDiseaseService";
		...
		try {
			...
			this.configuration = (StudyDiseaseServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
