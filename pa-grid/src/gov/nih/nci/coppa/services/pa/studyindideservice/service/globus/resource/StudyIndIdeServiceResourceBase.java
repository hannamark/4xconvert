 ...
 * 
 */
public abstract class StudyIndIdeServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyIndIdeServiceResourceBase.class);

	private StudyIndIdeServiceResourceConfiguration configuration;
    ...
    public StudyIndIdeServiceResourceBase() {
    }
	...
	public StudyIndIdeServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyIndIdeService";
		...
		try {
			...
			this.configuration = (StudyIndIdeServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
