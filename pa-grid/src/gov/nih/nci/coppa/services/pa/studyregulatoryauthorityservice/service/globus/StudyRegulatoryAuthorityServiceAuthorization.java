 ...
 * 
 */
public class StudyRegulatoryAuthorityServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyRegulatoryAuthorityService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyRegulatoryAuthorityServiceAuthorization() {
	}
