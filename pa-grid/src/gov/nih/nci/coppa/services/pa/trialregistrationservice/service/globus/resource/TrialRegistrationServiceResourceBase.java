 ...
 * 
 */
public abstract class TrialRegistrationServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(TrialRegistrationServiceResourceBase.class);

	private TrialRegistrationServiceResourceConfiguration configuration;
    ...
    public TrialRegistrationServiceResourceBase() {
    }
	...
	public TrialRegistrationServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/TrialRegistrationService";
		...
		try {
			...
			this.configuration = (TrialRegistrationServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
