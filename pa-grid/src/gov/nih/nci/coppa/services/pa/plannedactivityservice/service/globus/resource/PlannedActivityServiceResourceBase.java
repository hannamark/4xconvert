 ...
 * 
 */
public abstract class PlannedActivityServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(PlannedActivityServiceResourceBase.class);

	private PlannedActivityServiceResourceConfiguration configuration;
    ...
    public PlannedActivityServiceResourceBase() {
    }
	...
	public PlannedActivityServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/PlannedActivityService";
		...
		try {
			...
			this.configuration = (PlannedActivityServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
