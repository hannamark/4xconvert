 ...
 * 
 */
public class StudySiteParticipationServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudySiteParticipationService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudySiteParticipationServiceAuthorization() {
	}
