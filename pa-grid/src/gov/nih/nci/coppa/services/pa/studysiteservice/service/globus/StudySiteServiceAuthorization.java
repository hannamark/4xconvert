 ...
 * 
 */
public class StudySiteServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudySiteService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudySiteServiceAuthorization() {
	}
