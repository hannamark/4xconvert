 ...
 * 
 */
public class DocumentWorkflowStatusServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/DocumentWorkflowStatusService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public DocumentWorkflowStatusServiceAuthorization() {
	}
