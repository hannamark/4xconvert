	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
			if(args[0].equals("-url")){
              ...
              StudySiteAccrualStatus[] rList = client.getCurrentStudySiteAccrualStatusByStudyParticipation(id);
              System.out.println(rList);

              System.out.println("Testing StudySiteAccrualStatus.getStudySiteAccrualStatusByStudyParticipation...");
              rList = client.getStudySiteAccrualStatusByStudyParticipation(id);
              System.out.println(rList);
