 ...
 * 
 */
public class StudyOutcomeMeasureServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyOutcomeMeasureService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyOutcomeMeasureServiceAuthorization() {
	}
