...
public class TrialRegistrationServiceProviderImpl{
    ...
    impl.reject(params.getStudyProtocol().getId(),params.getRejectionReason().getST());
    return boxedResult;
  }
