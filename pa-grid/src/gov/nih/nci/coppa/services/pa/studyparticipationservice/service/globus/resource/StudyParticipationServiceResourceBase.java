 ...
 * 
 */
public abstract class StudyParticipationServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyParticipationServiceResourceBase.class);

	private StudyParticipationServiceResourceConfiguration configuration;
    ...
    public StudyParticipationServiceResourceBase() {
    }
	...
	public StudyParticipationServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyParticipationService";
		...
		try {
			...
			this.configuration = (StudyParticipationServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
