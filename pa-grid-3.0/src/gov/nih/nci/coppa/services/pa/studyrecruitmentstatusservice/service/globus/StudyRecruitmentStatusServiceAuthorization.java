 ...
 * 
 */
public class StudyRecruitmentStatusServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices/StudyRecruitmentStatusService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyRecruitmentStatusServiceAuthorization() {
	}
