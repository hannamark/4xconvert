 ...
 * 
 */
public abstract class StudyResourcingServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyResourcingServiceResourceBase.class);

	private StudyResourcingServiceResourceConfiguration configuration;
    ...
    public StudyResourcingServiceResourceBase() {
    }
	...
	public StudyResourcingServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyResourcingService";
		...
		try {
			...
			this.configuration = (StudyResourcingServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
