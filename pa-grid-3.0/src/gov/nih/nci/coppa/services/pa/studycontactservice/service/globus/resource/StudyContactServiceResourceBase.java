 ...
 * 
 */
public abstract class StudyContactServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyContactServiceResourceBase.class);

	private StudyContactServiceResourceConfiguration configuration;
    ...
    public StudyContactServiceResourceBase() {
    }
	...
	public StudyContactServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyContactService";
		...
		try {
			...
			this.configuration = (StudyContactServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
