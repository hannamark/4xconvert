 ...
 * 
 */
public abstract class StudySiteAccrualStatusServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudySiteAccrualStatusServiceResourceBase.class);

	private StudySiteAccrualStatusServiceResourceConfiguration configuration;
    ...
    public StudySiteAccrualStatusServiceResourceBase() {
    }
	...
	public StudySiteAccrualStatusServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudySiteAccrualStatusService";
		...
		try {
			...
			this.configuration = (StudySiteAccrualStatusServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
