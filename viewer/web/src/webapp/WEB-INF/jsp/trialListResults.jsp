...
<display:table class="data" sort="list" pagesize="20" id="row" name="sessionScope.displayTagList" requestURI="trialListgetReport.action">
    <display:column titleKey="trialList.result.organization" property="organization" sortable="true" headerClass="sortable"/>
    <display:column titleKey="trialList.result.dateLastCreated" property="dateLastCreated" sortable="true" headerClass="sortable"/>
    <display:column titleKey="trialList.result.assignedIdentifier" property="assignedIdentifier" sortable="true" headerClass="sortable"/>
    <display:column titleKey="trialList.result.officialTitle" property="officialTitle" sortable="true" headerClass="sortable"/>
