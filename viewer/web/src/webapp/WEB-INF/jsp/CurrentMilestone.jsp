...
<c:set var="topic" scope="request" value="run_current_milestone"/> 
<head>
<title><fmt:message key="currentMilestone.header" /></title>
<s:head />
...
function handleAction(){
    document.forms[0].action="resultsCurrentMilestone.action";
    document.forms[0].submit();
}
function handleReset(){
    document.forms[0].action="criteriaCurrentMilestone.action";
    document.forms[0].submit();
}
</script>
</head>
<body>
<!-- main content begins-->
    <h1><fmt:message key="currentMilestone.header"/></h1>
    <s:form name="criteria">
        ...
        <s:if test="%{resultList != null}">
            <table width="100%">
            <tr><td colspan="2">
                <h2><fmt:message key="currentMilestone.header"/></h2>
            </td></tr>
            <tr>
                <td>
            ...
            <display:table class="data" pagesize="20" id="row" name="sessionScope.displayTagList" 
                    requestURI="resultsCurrentMilestone.action" export="true">
