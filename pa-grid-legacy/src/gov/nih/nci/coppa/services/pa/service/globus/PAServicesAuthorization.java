 ...
 * 
 */
public class PAServicesAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://enterpriseservices.nci.nih.gov/PAServices";
	
	Map authorizationClassMap = new HashMap();
	
	
	public PAServicesAuthorization() {
	}
