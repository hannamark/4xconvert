 ...
 * 
 */
public abstract class DocumentWorkflowStatusServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(DocumentWorkflowStatusServiceResourceBase.class);

	private DocumentWorkflowStatusServiceResourceConfiguration configuration;
    ...
    public DocumentWorkflowStatusServiceResourceBase() {
    }
	...
	public DocumentWorkflowStatusServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/DocumentWorkflowStatusService";
		...
		try {
			...
			this.configuration = (DocumentWorkflowStatusServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
