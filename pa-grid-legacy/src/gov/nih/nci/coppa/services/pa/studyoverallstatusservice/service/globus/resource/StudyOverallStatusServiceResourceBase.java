 ...
 * 
 */
public abstract class StudyOverallStatusServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(StudyOverallStatusServiceResourceBase.class);

	private StudyOverallStatusServiceResourceConfiguration configuration;
    ...
    public StudyOverallStatusServiceResourceBase() {
    }
	...
	public StudyOverallStatusServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyOverallStatusService";
		...
		try {
			...
			this.configuration = (StudyOverallStatusServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
